...
HU General is a standalone Drupal theme that ships with its own bundled component library and Howard University-specific customizations.
...
- **Parent School/College/Organization URL**: Add the URL to parent school or college, for example `<https://coas.howard.edu>`
...
The theme includes a bundled component library for consistent styling and components:
